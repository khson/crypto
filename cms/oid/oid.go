...
var (
	...
	AttributeKoscomType = asn1.ObjectIdentifier{1, 2, 410, 200005, 1, 10, 1}
	CrossWebReplayType  = asn1.ObjectIdentifier{1, 3, 6, 1, 4, 1, 7150, 4, 1}
	CrossWebVidType     = asn1.ObjectIdentifier{1, 3, 6, 1, 4, 1, 7150, 3, 1}
)
